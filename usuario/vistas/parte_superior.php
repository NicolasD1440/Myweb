        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dashboard.php">
                    ...
                    <span>Perfil del usuario</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="coment_res.php">Mis respuestas</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php
                        $conexion = mysqli_connect("localhost","root","","jjd-food");
                        $query = "SELECT count(estado) FROM mensajes WHERE estado= 1 and id = $Datos[0]";
                        $resultado = mysqli_query($conexion,$query);
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="coment_res.php">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Tienes <?php echo $mensajes[0] ?> respuestas</div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $Datos[2]." ".$Datos[3]?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="../logout/logout.php" data-toggle="modal" data-target="#logoutModal">
